...
\ENDIF
\end{algorithmic}
\label{fig 4 : Strong 4 Clique finder+ with lower degree check}
\end{algorithm}
...
\RETURN $best\_clique$
\end{algorithmic}
\label{fig 5 : Strong 4 Clique finder++}
\end{algorithm}
...
The implemented algorithms are benchmarked to validate the intended performance enhancement. The first benchmark is performed on a small dataset. The dataset is then extended and benchmarked again.\newline
